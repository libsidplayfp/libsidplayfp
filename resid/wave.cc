...
const waveformconfig_t wfconfig[3][5] = {
  ...
  { /* kevtris chip G (6581r2/r3) */
    ...
    {0.8724341f, 1.651281f, 1.207028f, 0.0042649f, 0.0f,},
    {0.9322616f, 0.6173857f, 0.0f, 0.06722359f, 0.2427691f,},
    { 0.5f, 0.0f, 1.0f, 0.0f, 0.0f },
  },
  { /* kevtris chip V (8580) */
    {0.9736353f, 0.0f, 0.9931195f, 2.565597f, 0.9484892f,},
    {0.9236207f, 2.19129f, 0.0f, 0.1108298f, 0.0f,},
    {0.922026f, 2.068005f, 0.9600384f, 0.1464829f, 0.0f,},
    {0.9758811f, 1.003464f, 1.004502f, 1.2674f, 0.9923877f,},
    { 0.5f, 0.0f, 1.0f, 0.0f, 0.0f },
  },
};
